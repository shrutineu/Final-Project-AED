 ...
 * @author Komal
 */
public class FireStationEnterpriseWorkArea extends javax.swing.JPanel {
    ...
    private Emergency e;
    public FireStationEnterpriseWorkArea(JPanel userProcessContainer, UserAccount account, EmergencySystem system, Network network, Enterprise enterprise) {
        initComponents();
   ...
   public void populateWorkRequestTable()
   {
    ...
    private void initComponents() {
        ...
        header.setText("Fire Station Enterprise Admin Work Area");
        ...
        alertambulanceBtn.setText("Alert Fire Brigade");
        ...
        enterpriseWorkArea.addTab("Alert Fire Brigade", alertAmbulance);
...
//            {
                ...
                if(rowNumber>=0)
                {
                    ...
                    userNameIsUnique=true;//system.checkIfUserNameIsUnique(username, password);
                    if(userNameIsUnique==true)
                    {
                    Doctor d=new Doctor();
                    ...
                    JOptionPane.showMessageDialog(this,"The fire station employee is created successfully");
                    nameTF.setText("");
                    usernameTF.setText("");
                    passwordTF.setText("");
                     ...
                     else if(org instanceof AmbulanceOrganisation)
                    {
                        ...
                        JOptionPane.showMessageDialog(this,"The fire brigade employee is created successfully");
                        nameTF.setText("");
                        usernameTF.setText("");
                        passwordTF.setText("");
                        availabilityTF.setText("");
...
//            }
    ...
    private void alertambulanceBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alertambulanceBtnActionPerformed
            ...
            Ambulance a=(Ambulance) ambulanceTable.getValueAt(rowSelected,0);
                ...
                for(Organisation org:hospital.getOrganizationDirectory().getOrganisationList())
                {
                    if(org instanceof AmbulanceOrganisation)
                    {
                        ...
                        {
                            if((user.getEmployee()==a)&&(!emer.getEmergencyStatus().equalsIgnoreCase("Assigned to fire brigade")))
                            {
                          
                                request.setSender(account);
                                request.setReceiver(user);
                                emer.setEmergencyStatus("Assigned to fire brigade");
                                user.getWorkQueue().getWorkRequestList().add(request);
                                ((Ambulance)user.getEmployee()).setAvailability("Not available");
                                 JOptionPane.showMessageDialog(this,"The fire brigade "+a.getName()+ " has been alerted about the emergency");
                                 populateAmbulanceTable();
                                 Date d=new Date();
                                ...
                                System.err.println("The time from hospital alerted to fire brigade dipatched"+emer.getTotalTimeToDispatchAmbulance());
                                 break;
                            }
                            
                            else
                            {
                                if(emer.getEmergencyStatus().equalsIgnoreCase("Assigned to fire brigade"))
                                {
                                JOptionPane.showMessageDialog(this, "For this emergency the fire brigade has already been alerted");
                                break;
                                }
        ...
        JOptionPane.showMessageDialog(this,"Choose a fire brigade from the table");
        }
    ...
    private void processEmergencyBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processEmergencyBtnActionPerformed
        ...
        if(rowSelected>=0)
        {
            ...
            JOptionPane.showMessageDialog(this, "Alert the fire brigade");
